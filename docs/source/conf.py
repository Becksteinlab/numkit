...
copyright = u'2009-{}, The Authors of numkit (see AUTHORS)'.format(now.year)

# The default replacements for |version| and |release|, also used in various
# other places throughout the built documents.
#
# Dynamically calculate the version (uses versioneer)
packageversion = __import__('numkit').__version__
...
latex_documents = [
  ('index', 'numkit.tex', u'numkit Documentation',
...
intersphinx_mapping = {'python': ('https://docs.python.org', None),
                       ...
                       'GromacsWrapper': ('https://gromacswrapper.readthedocs.org/en/latest', None),
                       }
